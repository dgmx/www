import{_ as i,o as a,c as n,ak as E}from"./chunks/framework.0gCUzwrR.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"databases/sql/gestion.md","filePath":"databases/sql/gestion.md","lastUpdated":1775408517000}'),h={name:"databases/sql/gestion.md"};function k(l,s,p,t,e,r){return a(),n("div",null,[...s[0]||(s[0]=[E(`<div class="language-mermaid mermaid-container" data-mermaid="true"><pre><code class="language-mermaid">erDiagram
...
</code></pre></div><div class="language-sql"><button title="Copy Code" class="copy"></button><span class="lang">sql</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">CREATE</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> TABLE</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> CLIENTES</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div>`,2)])])}const A=i(h,[["render",k]]);export{g as __pageData,A as default};
