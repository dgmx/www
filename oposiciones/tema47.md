...
3. INSTALACIÓN DE APLICACIONES INFORMÁTICAS
   3.1. FASES DEL PROCESO DE INSTALACIÓN
   3.2. INSTALADORES Y TECNOLOGÍAS DE EMPAQUETADO
   3.3. INSTALACIÓN AVANZADA: SERVICIOS DE WINDOWS INSTALLER
   3.4. DESINSTALACIÓN Y GESTIÓN DEL CICLO DE VIDA
4. EXPLOTACIÓN DE APLICACIONES INFORMÁTICAS
   4.1. CARACTERÍSTICAS DE UNA CORRECTA EXPLOTACIÓN
   4.2. RECURSOS PARA UNA CORRECTA EXPLOTACIÓN
   4.3. OPERACIONES DIARIAS DE EXPLOTACIÓN
   4.4. BUENAS PRÁCTICAS EN LA EXPLOTACIÓN
5. COMPARTICIÓN DE DATOS
   5.1. SISTEMAS MULTIUSUARIO
   5.2. SISTEMAS MULTITAREA
   5.3. COMPARTICIÓN DE DATOS EN LA NUBE
6. CONCLUSIÓN
7. BIBLIOGRAFÍA
```
