...
echo "Hola, Mundo!"
echo "Bienvenido al mundo de Administración de Sistemas Operativos"
```
...
```
Hola, Mundo!
Bienvenido al mundo de Administración de Sistemas Operativos
```
...
*Manual de Programación en Shell Script*
